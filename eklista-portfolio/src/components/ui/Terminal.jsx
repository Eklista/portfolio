...
const DraggableTerminal = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-800/80 backdrop-blur-sm px-4 py-3 flex items-center justify-between border-b border-gray-700/50 cursor-move">
        <div className="flex items-center space-x-3">
          {/* Traffic Light Buttons */}
          <div className="flex space-x-2">
            <button
              onClick={onClose}
              className="w-3 h-3 bg-red-500 rounded-full hover:bg-red-600 transition-colors shadow-sm flex items-center justify-center group"
            >
              <X size={8} className="text-red-800 opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
            <button
              onClick={onMinimize}
              className="w-3 h-3 bg-yellow-500 rounded-full hover:bg-yellow-600 transition-colors shadow-sm flex items-center justify-center group"
            >
              <Minus size={8} className="text-yellow-800 opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
            <button className="w-3 h-3 bg-green-500 rounded-full hover:bg-green-600 transition-colors shadow-sm flex items-center justify-center group">
      ...
      <div className="p-4 h-full overflow-hidden">
        <div className="font-mono text-sm leading-relaxed h-full overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
